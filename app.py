...
mydb=mysql.connector.connect(host='localhost',user='root',password='1234',db='blog')
with mysql.connector.connect(host='localhost',user='root',password='1234',db='blog'):
